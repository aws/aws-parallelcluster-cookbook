...
depends 'aws-parallelcluster-platform', '~> 3.8.0'
depends 'aws-parallelcluster-environment', '~> 3.8.0'
depends 'aws-parallelcluster-computefleet', '~> 3.8.0'
depends 'aws-parallelcluster-slurm', '~> 3.8.0'
depends 'aws-parallelcluster-awsbatch', '~> 3.8.0'
