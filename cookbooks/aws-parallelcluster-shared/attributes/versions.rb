...
default['cluster']['parallelcluster-version'] = '3.17.0'
default['cluster']['parallelcluster-cookbook-version'] = '3.17.0'
default['cluster']['parallelcluster-node-version'] = '3.17.0'
