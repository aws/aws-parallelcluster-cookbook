...
default['cluster']['parallelcluster-version'] = '3.14.2'
default['cluster']['parallelcluster-cookbook-version'] = '3.14.2'
default['cluster']['parallelcluster-node-version'] = '3.14.2'
