...
### [:after](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/after.md)
...
### [:before](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/before.md)

Inserts lines before a matching line.

Arguments: pattern to match insert lines, string or array of lines to insert, `:each`, `:first`, or `:last` to select the matching lines, options.

### [:between](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/between.md)

Inserts lines between matched lines.

Arguments: pattern to insert after, pattern to insert before, lines to insert.

### [:comment](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/comment.md)

Changes lines to comments.

Arguments: pattern to match lines, comment string, string to add after the comment indicator.

### [:delete_between](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/delete_between.md)
...
### [:missing](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/missing.md)

Inserts lines before or after existing lines.

Arguments: string or array of lines to add, `:before` or `:after`.

### [:replace](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/replace.md)

Replaces matching lines.

Arguments: pattern to match lines, string or array to replace the matched line, options.

### [:replace_between](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/replace_between.md)
...
### [:stanza](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/stanza.md)
...
### [:substitute](https://github.com/sous-chefs/line/blob/main/documentation/resources/filters/substitute.md)
