...
sed -i "s/default\['cfncluster'\]\['cfncluster-cookbook-version'\] = '$CURRENT_VERSION'/default['cfncluster']['cfncluster-cookbook-version'] = '$NEW_VERSION'/g" attributes/default.rb
