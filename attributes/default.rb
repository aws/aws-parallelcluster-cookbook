...
default['cluster']['stunnel']['url'] = "https://#{node['cluster']['artifacts_s3_url']}.s3.amazonaws.com/archives/stunnel/stunnel-5.67.tar.gz" # "https://www.stunnel.org/downloads/stunnel-#{node['cluster']['stunnel']['version']}.tar.gz"
