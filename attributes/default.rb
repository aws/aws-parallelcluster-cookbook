...
default['cluster']['stunnel']['url'] = "https://aws-parallelcluster-dev-commercial.s3.amazonaws.com/archives/stunnel/stunnel-5.67.tar.gz" # "https://www.stunnel.org/downloads/stunnel-#{node['cluster']['stunnel']['version']}.tar.gz"
